...
const ContactUs = () => {
  return (
    ...
    >
      <section className="flex flex-col items-center h-[80vh] w-full relative z-0 ">
        <div className="flex flex-row w-full h-full relative justify-between items-center my-[10vh] rounded-xl overflow-hidden [border-image:linear-gradient(to_right,#0087B2,#FFFFFF,#043357)_1] border-[1px]">
          ...
          <div className="flex flex-col w-[50%] items-start justify-center px-8">
