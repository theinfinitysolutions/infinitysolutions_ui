export const serviceList = [
  {
    ...
    description:
      "Crafting user-centric websites with cutting-edge technologies for seamless digital experiences and enhanced brand presence.",
    applications: [
      "E-commerce",
      "CMS Development",
      "Web Application",
  ...
  },
  {
    ...
    description:
      "Building intuitive and feature-rich mobile applications tailored to meet diverse user needs across platforms.",
    applications: [
      "iOS App",
      "Android App",
      "Cross-platform App",
  ...
  },
  {
    title: "Data Mining",
    description:
      "Extracting valuable insights from large datasets using advanced algorithms and techniques for informed decision-making.",
    applications: [
      "Market Research",
  ...
  },
  {
    ...
    description:
      "Creating interactive dashboards and performing in-depth data analysis to drive actionable insights and strategic decisions.",
    applications: [
  ...
  },
  {
    ...
    description:
      "Designing comprehensive Enterprise Resource Planning systems to optimize business processes and enhance organizational efficiency.",
    applications: [
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A hospital management system for managing patient records, appointments, and medical services.",
    image: "/raksheet.png",
    type: "Website",
    location: "India",
    testimonial: {
      name: "Raksheet Jain",
      designation: "Director, Raksheet Hospital",
      message:
        "The team at Infinity Solutions developed a robust and user-friendly hospital management system for us. It has streamlined our operations and improved patient care.",
    },
    industry: "Healthcare Services",
    link: "http://144.24.111.231:7005",
    techStack: [
      {
        image: "/nextjs.png",
        title: "NextJS",
